package com.yarik.silenttime.Services;
...
import com.yarik.silenttime.Broadcastreceivers.SilentAlarmReceiver;
import com.yarik.silenttime.Broadcastreceivers.SilentBootReceiver;
...
{
    public static final String ALARM_ACTION = SilentAlarmReceiver.ACTION_START_SILENCER_SERVICE_ALARM;
    ...
    public void setAlarm(Context context, int id, int dayOfWeek, int hour, int minute, String notifTime)
    {
        ...
        // device is rebooted.
        ComponentName receiver = new ComponentName(context, SilentBootReceiver.class);
