package com.yarik.silenttime.Fragments;
...
import com.yarik.silenttime.Activities.MainActivity;
import com.yarik.silenttime.R;
import com.yarik.silenttime.Services.SilentTimeService;
import com.yarik.silenttime.Models.Silencer;
import com.yarik.silenttime.Utils.SilentContentProvider;
...
public class TimeDetailsFragment extends Fragment implements View.OnClickListener
{
                                ...
                                int startMinute, int endHour, int endMinute, String notifTime)
    {
        ...
        if (sunday)
        {
            ...
            alarm.setAlarm(context, startAlarmID, Calendar.SUNDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.SUNDAY, endHour, endMinute, notifTime);
        }
        ...
        if (monday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.MONDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.MONDAY, endHour, endMinute, notifTime);
        }
        ...
        if (tuesday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.TUESDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.TUESDAY, endHour, endMinute, notifTime);
        }
        ...
        if (wednesday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.WEDNESDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.WEDNESDAY, endHour, endMinute, notifTime);
        }
        ...
        if (thursday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.THURSDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.THURSDAY, endHour, endMinute, notifTime);
        }
        ...
        if (friday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.FRIDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.FRIDAY, endHour, endMinute, notifTime);
        }
        ...
        if (saturday)
        {
            ...
            endAlarmID = startAlarmID * multiplicand;
            alarm.setAlarm(context, startAlarmID, Calendar.SATURDAY, startHour, startMinute, notifTime);
            alarm.setAlarm(context, endAlarmID, Calendar.SATURDAY, endHour, endMinute, notifTime);
        }
    }
